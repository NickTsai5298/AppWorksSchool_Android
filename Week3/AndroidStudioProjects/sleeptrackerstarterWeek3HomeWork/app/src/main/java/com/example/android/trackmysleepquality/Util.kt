...
fun convertQualityTextToString(qualitytext: String, resources: Resources): String {
var qualitytexttoString = qualitytext.toString()
    return qualitytexttoString
}
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTimeMilli != it.startTimeMilli) {
                ...
                append("\t${convertQualityTextToString(it.qualitytext, resources)}<br>")
